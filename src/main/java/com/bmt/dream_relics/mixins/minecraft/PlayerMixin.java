...
public class PlayerMixin {
    @WrapOperation(method = {"dropEquipment", "getExperienceReward"}, at = @At(value = "INVOKE", target = "Lnet/minecraft/world/level/GameRules;getBoolean(Lnet/minecraft/world/level/GameRules$Key;)Z"))
